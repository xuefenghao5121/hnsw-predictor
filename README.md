...
> **SIFT1M**: 512MB cgroup, 95.70% recall / **5247 QPS** (4T) / vs hnswlib **10x** (5247 vs 527)
> **DEEP10M**: 2GB cgroup, 95.15% recall / **1762 QPS** (12T) / hnswlib OOM (需 6GB)
> **DEEP10M 紧凑**: 1.5GB cgroup, 95.15% recall / **327 QPS** (12T) / hnswlib 不可运行
>
> 所有数字均为诚实测量 (drop_caches + cgroup v2, DEC-039)
...
| QPS @512MB cgroup | 527 | **5247** (**10x**) |
| QPS @600MB cgroup | 2000 | **5124** (**2.6x**) |
| RSS | 726MB(OOM@512MB 实际 492MB 挣扎) | **275MB** |
