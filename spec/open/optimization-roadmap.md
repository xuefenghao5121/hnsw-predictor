...
> 更新: 2026-07-30 (DEC-049~050: Page Shuffle/Search 10M 验证关闭)
...
| DEC-038 | 图裁剪 10M | 0% recall loss, 0% QPS gain | CSR 非瓶颈 |
...
| ID | 优化 | 1M 收益 | 10M 结果 | 最终结论 |
|----|------|---------|---------|----------|
| DEC-018 | Page Shuffle | +2.1% | **-2.6%~-27.8%** | ❌ 正式关闭 (DEC-049) |
| DEC-017 | Page Search | +2% (冷态) | 未实施 | ❌ 逻辑关闭 (DEC-050) |
...
| 6 | **Page Shuffle @10M** (DEC-018) | ❌ 已关闭 (DEC-049) | - | - |

### 🟢 优先级 3: 内存压缩 (P3 100M 前置)

| # | 优化 | 效果 | 难度 | 状态 |
|---|------|------|------|------|
| 7 | **PQ codes mmap** (P3-5) | 减少 304MB 匿名 | 🟡 中 | 未开始 |
| 8 | **上层向量 PQ 编码** (P3-6) | 减少 228MB 匿名 (10M) | 🟡 中 | 未开始 |
| 9 | **路由表内存优化** (P3-8) | 减少 ~40MB | 🟢 低 | 未开始 |

### ⚪ 优先级 4: 长期探索 (P4-P5)

| # | 优化 | 效果 | 难度 | 状态 |
|---|------|------|------|------|
| 10 | **100M 数据集** (P3-7) | 验证规模上限 | 🔴 高 | 未开始 |
| 11 | **SPDK 用户态 I/O** (DEC-027) | 2-3x I/O 带宽 | 🔴 高 | P4 探索 |
| 12 | **学习式剪枝 GBDT** (DEC-028) | 1.1-1.6x 吞吐 | 🔴 高 | P2.5 探索 |
| 13 | **GPU/PMEM/NUMA** (P5) | 未知 | 🔴 高 | P5 探索 |
| 14 | **Q-002 学习式剪枝可行性** | - | 🔴 高 | 开放 |
